...
build/Task.o: src/Task.cpp src/Task.hpp src/json.hpp src/utils.hpp | prebuild
	$(CC) $(CCFLAGS) -c src/Task.cpp -o build/Task.o

build/TaskManager.o: src/TaskManager.cpp src/TaskManager.hpp src/Task.hpp src/json.hpp src/utils.hpp | prebuild
...
test_task: tests/test_task.cpp src/json.hpp src/utils.hpp build/Task.o
